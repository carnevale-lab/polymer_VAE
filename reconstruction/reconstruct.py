...
def main(args):
    ...
    sample_dataset = tf.data.Dataset.from_tensor_slices((X_reshaped[:rec_samples], T[:rec_samples]))\
                    .prefetch(AUTO)\
...
if __name__ == "__main__":
    ...
    parser.add_argument("--rec_samples", type=int, default=10, help="Number of input samples to reconstruct")
