...
def main(args):
    ...
    gmm_sampler = GMMSampling(n_components=GMM_components, encoder=encoder, latent_dim=latent_dim)
    ...
    for i in temp_sampling:
        ...
        all_generated_matrices.append(new_samples)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--gmm_components", type=int, default=300, help="Number of Gaussian Mixture components")
