...
<p align="center">
  <img width="100%" height="auto" src="https://github.com/carnevale-lab/polymer_VAE/blob/c1ab72bf33be6e8048f0dfd78ba97ed387bcbff6/model_architecture.png">
</p>
...
```
usage: reconstruct.py [--npy_file INPUT_npy_FILE] [--temps_file TEMP_FILE] [--atoms ATOMS] [--batch_size_per_gpu BATCH_SIZE] [--rec_samples NUMBER_OF_RECONSTRUCTED_SAMPLES]

optional arguments:
  --rec_samples          Number of input samples to reconstruct (default = 10).
```
...
```
usage: latent_space_analyze.py [--npy_file INPUT_npy_FILE] [--temps_file TEMP_FILE] [--energies_file ENERGY_FILE] [--latent_dim LATENT_DIM] [--atoms ATOMS] [--batch_size_per_gpu BATCH_SIZE]
...
```
usage: generation.py [--npy_file INPUT_npy_FILE] [--temps_file TEMP_FILE] [--latent_dim LATENT_DIM] [--atoms ATOMS] [--batch_size_per_gpu BATCH_SIZE] [--gmm_components NUMBER_OF_GMM_COMPONENTS] [--gen_samples NUMBER_OF_GENERATED_SAMPLES]

optional arguments:
  --gmm_components       Number of Gaussian Mixture components (default = 300).
